  ...
  setupXR() {
    ...
    this.gestures.addEventListener("pan", (ev) => {
      ...
      if (ev.initialise !== undefined) {
        ...
        self.ui.updateElement(
          "info",
          `pan x:${ev.delta.x.toFixed(3)}
          y:${ev.delta.y.toFixed(3)}
          z:${ev.delta.z.toFixed(3)}}`
        );
      }
    });
    ...
    this.gestures.addEventListener("pinch", (ev) => {
      ...
      if (ev.initialise !== undefined) {
        ...
        self.ui.updateElement(
          "info",
          `pinch delta:${ev.delta.toFixed(3)}
    ...
    this.gestures.addEventListener("rotate", (ev) => {
      ...
      if (ev.initialise !== undefined) {
        ...
        self.knight.object.quaternion.copy(self.satrtQuaternion);
